...
import { DIRECTORY, SERVER_ROUTE, API_ROUTE, ENVIRONMENT, SERVER, API, DATABASE, MAIL } from './config.js';
...
if (!(ENVIRONMENT.PRODUCTION)) api.use(API_ROUTE.TEMP.RESET_DATABASE, apiTempResetDatabase);
